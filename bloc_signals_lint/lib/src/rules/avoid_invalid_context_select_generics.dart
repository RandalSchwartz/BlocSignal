...
/// A lint rule that catches incorrect usages of `context.select` with 3 generic type parameters.
///
/// In `bloc_signals_flutter`, `context.select<B, R>` takes 2 generic type parameters:
...
class AvoidInvalidContextSelectGenerics extends DartLintRule {
  ...
  static const _code = LintCode(
    ...
    problemMessage:
        'In "bloc_signals_flutter", "context.select<B, R>" takes 2 generic type parameters (<Bloc, Selected>) instead of 3.',
    correctionMessage:
        'Remove the redundant State generic argument. Use "context.select<Bloc, Selected>((bloc) => ...)" instead.',
  );
