...
const List<PublicationItem> _publications = [
  ...
  PublicationItem(
    ...
    url:
        'https://dev.to/gde/layered-architecture-in-flutter-with-blocsignal-1a1a',
    date: 'Jul 31, 2026',
    readTime: '8 min read',
    category: 'Flutter & Jaspr',
    type: 'Article',
  ...
  PublicationItem(
    ...
    url:
        'https://dev.to/gde/how-we-achieved-full-bloc-api-protocol-parity-in-blocsignal-020-mdp',
    date: 'Jul 21, 2026',
    readTime: '5 min read',
    category: 'State Machines',
    type: 'Article',
