...
const List<PackageItem> _allPackages = [
  PackageItem(
    ...
    version: '1.0.0',
    desc:
        'Core pure Dart reactive state container bridging BLoC semantics with Preact Signals v7 primitives.',
    icon: '⚡',
    category: 'Core & UI',
  ...
  PackageItem(
    ...
    version: '1.1.0',
    desc:
        'Flutter UI bindings, InheritedWidget providers, builders, listeners, selectors, and Listenable interop.',
    icon: '💙',
    category: 'Core & UI',
  ...
  PackageItem(
    ...
    version: '1.0.0+1',
    desc:
        'Bidirectional Riverpod 2 & 3 interop adapters (toBlocSignal / toProvider / ProviderListenable).',
    icon: '🌊',
  ...
  PackageItem(
    ...
    version: '1.0.1',
    desc:
        'Synchronous state persistence across app restarts with primitive and collection storage support.',
    icon: '💾',
    category: 'State & Interop',
  ...
  PackageItem(
    ...
    version: '1.0.0',
    desc:
        'Replay, undo, and redo state tracking utilities (ReplayCubit, ReplayBloc, ReplayEvent).',
    icon: '↩️',
    category: 'State & Interop',
  ...
  PackageItem(
    ...
    version: '1.0.0',
    desc:
        'Custom Flutter DevTools extension for timeline tracing, state diffing, and memory leak detection.',
    icon: '🛠️',
    category: 'DevTools & Tooling',
...
class PackageCatalog extends StatefulComponent {
          ...
          div(classes: 'catalog-controls', [
            div(classes: 'catalog-search-wrapper', [
              ...
              input(
                ...
                attributes: {
                  'placeholder':
                      'Search packages (e.g. hydrate, flutter, riverpod, otel)...',
