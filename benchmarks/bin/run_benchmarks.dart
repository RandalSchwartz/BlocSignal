...
Future<void> main() async {
  final runners = <_BenchmarkRunner>[
    _BenchmarkRunner(
        'Raw Signals (signal.value)', RawSignalThroughputBenchmark()),
    ...
    _BenchmarkRunner(
        'BlocSignal + Subscriber', BlocSignalWithListenerBenchmark()),
    _BenchmarkRunner(
        'Provider (ChangeNotifier)', ProviderThroughputBenchmark()),
    ...
    _BenchmarkRunner(
        'Classic Bloc.add (Buffer Only)', ClassicBlocThroughputBenchmark()),
    _BenchmarkRunner('Classic Bloc + Listener (Buffer Only)',
        ClassicBlocWithListenerBenchmark()),
    _BenchmarkRunner(
        'Classic Bloc (Drained Stream)', ClassicBlocDrainedBenchmark()),
  ];
