  ...
  Component build(BuildContext context) {
    final blocPorts = [
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_timer',
      ),
      (
        title: 'Flutter Todos',
        tag: 'felangel/bloc',
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_todos',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_weather',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_dynamic_form',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_wizard',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_form_validation',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/bloc_concurrency_visualizer',
      ),
      (
        title: 'GitHub Search',
        tag: 'felangel/bloc',
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/github_search',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_complex_list',
      ),
      (
        ...
        upstreamUrl: 'https://github.com/felangel/bloc/tree/master/examples/flutter_bloc_with_stream',
      ),
    ];
    ...
    final signalsPorts = [
      (
        ...
        upstreamUrl: 'https://github.com/rodydavis/signals.dart/tree/main/examples/eval_calculator',
        demoUrl: null,
      ),
      (
        ...
        upstreamUrl: 'https://github.com/rodydavis/signals.dart/tree/main/examples/flutter_colorband',
        demoUrl: null,
      ),
      (
        ...
        upstreamUrl: 'https://github.com/rodydavis/signals.dart/tree/main/examples/get_it_signals',
        demoUrl: null,
      ),
      (
        ...
        upstreamUrl: 'https://github.com/rodydavis/signals.dart/tree/main/examples/flutter_async',
        demoUrl: null,
      ),
      (
        ...
        upstreamUrl: 'https://github.com/rodydavis/signals.dart/tree/main/examples/clean_architecture',
        demoUrl: null,
      ),
      (
        ...
        upstreamUrl: 'https://github.com/rodydavis/signals.dart/tree/main/examples/persist_shared_preferences',
        demoUrl: null,
      ),
      (
    ...
    riverpodPorts = [
      (
        ...
        upstreamUrl: 'https://github.com/rrousselGit/riverpod/tree/master/examples/todos',
        demoUrl: null,
      ),
      (
      ...
      (
        ...
        tag: 'rrousselGit/riverpod',
        desc: 'Marvel character browser with search, pagination, and details view.',
        ...
        upstreamUrl: 'https://github.com/rrousselGit/riverpod/tree/master/examples/marvel',
        demoUrl: null,
      ),
    ];
    ...
    return section(
      ...
      [
        div(classes: 'container', [
          div(classes: 'section-badge', [Component.text('Comparison Suite')]),
            ...
            for (final ex in blocPorts)
              div(classes: 'package-card', [
                div(classes: 'card-header', [
                  ...
                  span(classes: 'card-version tag-bloc', [
          ...
          div(classes: 'package-grid', [
            for (final ex in signalsPorts)
              div(classes: 'package-card', [
                div(classes: 'card-header', [
                  span(classes: 'card-icon', [Component.text(ex.icon)]),
                  span(classes: 'card-version tag-signals', [
                    Component.text(ex.tag),
                  ]),
                ]),
                h3(classes: 'card-title', [Component.text(ex.title)]),
                ...
                div(classes: 'card-links-row', [
                  if (ex.demoUrl != null) ...[
                    a(href: ex.demoUrl!, classes: 'card-link demo-link', [
          ...
          div(classes: 'package-grid', [
            for (final ex in riverpodPorts)
              div(classes: 'package-card', [
                div(classes: 'card-header', [
                  span(classes: 'card-icon', [Component.text(ex.icon)]),
                  span(classes: 'card-version tag-riverpod', [
                    Component.text(ex.tag),
                  ]),
                ]),
                h3(classes: 'card-title', [Component.text(ex.title)]),
